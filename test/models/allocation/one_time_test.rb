...
class Allocation::OneTimeTest < ActiveSupport::TestCase
  ...
  test "one_time_amount_max is the remaining budget for a new allocation" do
    ...
    assert_equal 5000, allocation.one_time_amount_max(scenario)
  end
  ...
  test "one_time_amount_max excludes the allocation's own amount when editing" do
    ...
    assert_equal 10000, allocation.one_time_amount_max(scenario)
  end
  ...
  test "one_time_amount_max is nil when no total giving amount is set" do
    ...
    assert_nil allocation.one_time_amount_max(scenario)
  end
end
